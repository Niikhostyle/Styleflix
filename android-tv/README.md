# VeoTV — APK para Android TV

App WebView a pantalla completa que abre tu VeoTV (Next.js) en la TV.
...
- El control remoto (D-pad) puede ser limitado: VeoTV es web; un mando con puntero / mouse ayuda.
